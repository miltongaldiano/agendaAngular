(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["demo-modules-min-max-date-module"],{
...
/***/ "./src/app/demo-modules/min-max-date/component.ts":
/*!********************************************************!*\
  !*** ./src/app/demo-modules/min-max-date/component.ts ***!
  \********************************************************/
...
function addPeriod(period, date, amount) {
    return {
        day: date_fns__WEBPACK_IMPORTED_MODULE_1__["addDays"],
        week: date_fns__WEBPACK_IMPORTED_MODULE_1__["addWeeks"],
        month: date_fns__WEBPACK_IMPORTED_MODULE_1__["addMonths"]
    }[period](date, amount);
}
function subPeriod(period, date, amount) {
    return {
        day: date_fns__WEBPACK_IMPORTED_MODULE_1__["subDays"],
        week: date_fns__WEBPACK_IMPORTED_MODULE_1__["subWeeks"],
        month: date_fns__WEBPACK_IMPORTED_MODULE_1__["subMonths"]
    }[period](date, amount);
}
function startOfPeriod(period, date) {
    return {
        day: date_fns__WEBPACK_IMPORTED_MODULE_1__["startOfDay"],
        week: date_fns__WEBPACK_IMPORTED_MODULE_1__["startOfWeek"],
        month: date_fns__WEBPACK_IMPORTED_MODULE_1__["startOfMonth"]
    }[period](date);
}
function endOfPeriod(period, date) {
    return {
        day: date_fns__WEBPACK_IMPORTED_MODULE_1__["endOfDay"],
        week: date_fns__WEBPACK_IMPORTED_MODULE_1__["endOfWeek"],
        month: date_fns__WEBPACK_IMPORTED_MODULE_1__["endOfMonth"]
    }[period](date);
}
var DemoComponent = /** @class */ (function () {
    function DemoComponent() {
        ...
        this.events = [];
        this.minDate = Object(date_fns__WEBPACK_IMPORTED_MODULE_1__["subMonths"])(new Date(), 1);
        this.maxDate = Object(date_fns__WEBPACK_IMPORTED_MODULE_1__["addMonths"])(new Date(), 1);
    ...
    DemoComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./template.html */ "./src/app/demo-modules/min-max-date/template.html"),
            styles: [__webpack_require__(/*! ./styles.css */ "./src/app/demo-modules/min-max-date/styles.css")],
...
/* harmony import */ var _component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./component */ "./src/app/demo-modules/min-max-date/component.ts");
...
/***/ "./src/app/demo-modules/min-max-date/styles.css":
/*!******************************************************!*\
  !*** ./src/app/demo-modules/min-max-date/styles.css ***!
  \******************************************************/
...
module.exports = ".cal-disabled {\n  background-color: #eee;\n  pointer-events: none;\n}\n\n.cal-disabled .cal-day-number {\n  opacity: 0.1;\n}"

/***/ })

}]);
//# sourceMappingURL=demo-modules-min-max-date-module.js.map