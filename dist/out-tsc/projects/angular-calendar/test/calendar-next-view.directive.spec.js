...
describe('mwlCalendarNextView directive', function () {
    ...
    it('should increase the view date by 1 month', function () {
    ...
    it('should increase the view date by 1 week', function () {
        var fixture = TestBed.createComponent(TestComponent);
    ...
    it('should increase the view date by 1 day', function () {
        var fixture = TestBed.createComponent(TestComponent);
    ...
    it('should increase the view date by 1 day, skipping weekends', function () {
        var fixture = TestBed.createComponent(TestComponent);
        fixture.componentInstance.view = 'day';
        ...
        fixture.nativeElement.querySelector('button').click();
        fixture.detectChanges();
        expect(fixture.componentInstance.viewDate).to.deep.equal(new Date('2018-06-18'));
        fixture.destroy();
    });
    it('should increase the view date by 4 days, skipping weekends', function () {
        var fixture = TestBed.createComponent(TestComponent);
        fixture.componentInstance.view = 'week';
        ...
        fixture.nativeElement.querySelector('button').click();
        fixture.detectChanges();
        expect(fixture.componentInstance.viewDate).to.deep.equal(new Date('2018-08-02'));
        fixture.destroy();
    });
});
//# sourceMappingURL=calendar-next-view.directive.spec.js.map